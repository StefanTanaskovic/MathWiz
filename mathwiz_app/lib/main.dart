...
void main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    StreamProvider<List<TriviaModel>>.value(value: HomepageStudentController().triviaList, initialData: null),
    StreamProvider<List<RaceTopModel>>.value(value: HomepageStudentController().raceList, initialData: null),
    StreamProvider<List<ClassModel>>.value(value: ClassListNotifier().classList, initialData: null),
