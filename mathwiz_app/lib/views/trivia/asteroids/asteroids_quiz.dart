...
class _AsteroidsQuizScreenState extends State<AsteroidsQuizScreen> {
          ...
          case "Waiting":
            {
              return Center(
                child: Padding(
                  ...
                  child: Text(
                    "The quiz will start once the teacher starts it. Be ready!",
  ...
  List<Widget> _buildQuiz(int i) {
    final asteroidList =
        Provider.of<List<AsteroidModel>>(context, listen: false) ?? [];
                      ...
                      child: Column(children: [
                        Stack(children: [
                          ...
                          (time.sec >= 3 && time.sec <= 6)
                              ...
                              : Text(""),
                          (time.sec < 3 && questionCorrect == true)
                              ? Image.asset(
                              ...
                              : Text(""),
                          (time.sec < 3 && questionCorrect == false)
                              ? Padding(
                                  padding: EdgeInsets.only(left: 22.0),
                                  child: Image.asset(
  ...
  Future<void> checkAnswer(
      int question, int answerPicked, quizID, userID) async {
